...
public class MainActivity extends AppCompatActivity {
    ...
    private Stack<LetterTile> placedTiles = new Stack<>(); //need this to hold placed tile
    ...
    public boolean onStartGame(View view) {
        ...
        Log.d("onStartGame", "word 1 - " + word1);
        Log.d("onStartGame", "word 2 - " + word2);
        ...
        while(counter1 < WORD_LENGTH || counter2 < WORD_LENGTH){
            ...
            if(random.nextInt(2) == 1 && counter1 < WORD_LENGTH) {
                scrambled += word1.charAt(counter1);
                counter1++;
            }
            else if (counter2 < WORD_LENGTH) {
                scrambled += word2.charAt(counter2);
                counter2++;
            }
        ...
        Log.d("onStart", "scrambled : " +scrambled);
